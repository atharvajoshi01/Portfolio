...
featured: true
tech: ["TensorFlow", "Python", "FFT", "Signal Processing", "CNN", "Real-time ML"]
---

## At a Glance

**Role:** ML Engineer (MMS LLC - Vibration Analytics Team)
**Duration:** 6 months (May 2024 - Nov 2024)
**Impact:** Production system reducing unplanned downtime by 35%
**Tech Stack:** TensorFlow, Python, FFT, NumPy, SciPy, Real-time Signal Processing
**Key Achievement:** 94% accuracy classifying 5 fault types from raw vibration data

### Key Metrics
- **Classification Accuracy:** 94% across 5 fault classes
